 ...
 */
add_filter( 'dynamic_sidebar_params', 'martek_widget_classes' );

if ( ! function_exists( 'martek_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function martek_widget_classes( $params ) {
...
} // End of if function_exists( 'martek_widget_classes' ).

add_action( 'widgets_init', 'martek_widgets_init' );

if ( ! function_exists( 'martek_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function martek_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Main Sidebar', 'martek' ),
				'id'            => 'main-sidebar',
				'description'   => __( 'Main sidebar widget area', 'martek' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<div class="widget-title font-size-20 font-weight-bold">',
				'after_title'   => '</div>',
			)
		);
		register_sidebar(
			array(
				...
				'after_widget'  => '</div>',
				'before_title'  => '<div class="widget-title font-size-20 font-weight-bold mb-3">',
				'after_title'   => '</div>',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Ads Top', 'understrap' ),
				'id'            => 'ads-top',
				'description'   => __( 'Main ads top area', 'understrap' ),
				'before_widget' => '',
				'after_widget'  => '',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Ads bottom', 'understrap' ),
				'id'            => 'ads-bottom',
				'description'   => __( 'Main ads bottom area', 'understrap' ),
				'before_widget' => '',
				'after_widget'  => '',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Ads after content', 'understrap' ),
				'id'            => 'ads-after-content',
				'description'   => __( 'Main ads after content area', 'understrap' ),
				'before_widget' => '',
				'after_widget'  => '',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'After content', 'understrap' ),
				'id'            => 'after-content',
				'description'   => __( 'Main after content area', 'understrap' ),
				'before_widget' => '',
				'after_widget'  => '',
			)
		);
	}
} // End of function_exists( 'martek_widgets_init' ).
