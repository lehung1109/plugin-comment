...
if ( ! function_exists( 'martek_pagination' ) ) {
	/**
	 ...
	 */
	function martek_pagination( $args = array(), $class = 'pagination justify-content-center mb-0' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'martek' ),
				'next_text'          => __( '&raquo;', 'martek' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'martek' ),
			)
		);
